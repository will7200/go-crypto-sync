...
// AcquireExecutedOrderListResponse AcquireExecutedOrderList Response Value
type AcquireExecutedOrderListResponse struct {
	// order count
...
func NewAcquireExecutedOrderListResponse() *AcquireExecutedOrderListResponse {
	this := AcquireExecutedOrderListResponse{}
	return &this
}
...
func (o AcquireExecutedOrderListResponse) MarshalJSON() ([]byte, error) {
...
type NullableAcquireExecutedOrderListResponse struct {
	value *AcquireExecutedOrderListResponse
	isSet bool
}

func (v NullableAcquireExecutedOrderListResponse) Get() *AcquireExecutedOrderListResponse {
	return v.value
}

func (v *NullableAcquireExecutedOrderListResponse) Set(val *AcquireExecutedOrderListResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAcquireExecutedOrderListResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAcquireExecutedOrderListResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcquireExecutedOrderListResponse(val *AcquireExecutedOrderListResponse) *NullableAcquireExecutedOrderListResponse {
	return &NullableAcquireExecutedOrderListResponse{value: val, isSet: true}
}

func (v NullableAcquireExecutedOrderListResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcquireExecutedOrderListResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
