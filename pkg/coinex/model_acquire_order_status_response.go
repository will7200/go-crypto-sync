...
// AcquireOrderStatusResponse AcquireOrderStatus Response Value
type AcquireOrderStatusResponse struct {
	// order count
...
func NewAcquireOrderStatusResponse() *AcquireOrderStatusResponse {
	this := AcquireOrderStatusResponse{}
	return &this
}
...
func (o AcquireOrderStatusResponse) MarshalJSON() ([]byte, error) {
...
type NullableAcquireOrderStatusResponse struct {
	value *AcquireOrderStatusResponse
	isSet bool
}

func (v NullableAcquireOrderStatusResponse) Get() *AcquireOrderStatusResponse {
	return v.value
}

func (v *NullableAcquireOrderStatusResponse) Set(val *AcquireOrderStatusResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAcquireOrderStatusResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAcquireOrderStatusResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcquireOrderStatusResponse(val *AcquireOrderStatusResponse) *NullableAcquireOrderStatusResponse {
	return &NullableAcquireOrderStatusResponse{value: val, isSet: true}
}

func (v NullableAcquireOrderStatusResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcquireOrderStatusResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
