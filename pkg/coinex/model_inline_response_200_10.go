...
type InlineResponse20010 struct {
	...
	Data    *AcquireMultipleOrdersResponse `json:"data,omitempty"`
}
...
func (o *InlineResponse20010) GetData() AcquireMultipleOrdersResponse {
	if o == nil || o.Data == nil {
		var ret AcquireMultipleOrdersResponse
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given AcquireMultipleOrdersResponse and assigns it to the Data field.
