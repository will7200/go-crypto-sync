...
type InlineResponse20014 struct {
	...
	Data    *PlaceLimitOrderResponse `json:"data,omitempty"`
}
...
func (o *InlineResponse20014) GetData() PlaceLimitOrderResponse {
	if o == nil || o.Data == nil {
		var ret PlaceLimitOrderResponse
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given PlaceLimitOrderResponse and assigns it to the Data field.
