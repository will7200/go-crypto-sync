...
type InlineResponse20017 struct {
	...
	Data    *AcquireExecutedOrderListResponse `json:"data,omitempty"`
}
...
func (o *InlineResponse20017) GetData() AcquireExecutedOrderListResponse {
	if o == nil || o.Data == nil {
		var ret AcquireExecutedOrderListResponse
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given AcquireExecutedOrderListResponse and assigns it to the Data field.
