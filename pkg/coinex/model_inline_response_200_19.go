...
type InlineResponse20019 struct {
	...
	Data    *AcquireUserDealsResponse `json:"data,omitempty"`
}
...
func (o *InlineResponse20019) GetData() AcquireUserDealsResponse {
	if o == nil || o.Data == nil {
		var ret AcquireUserDealsResponse
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given AcquireUserDealsResponse and assigns it to the Data field.
