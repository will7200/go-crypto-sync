...
type InlineResponse20022 struct {
	...
	Data    *SubmitWithdrawalOrderResponse `json:"data,omitempty"`
}
...
func (o *InlineResponse20022) GetData() SubmitWithdrawalOrderResponse {
	if o == nil || o.Data == nil {
		var ret SubmitWithdrawalOrderResponse
		return ret
	}
	return *o.Data
}
...
// SetData gets a reference to the given SubmitWithdrawalOrderResponse and assigns it to the Data field.
