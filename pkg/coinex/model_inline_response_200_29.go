...
type InlineResponse20029 struct {
	...
	Data    *PlaceLoanResponse `json:"data,omitempty"`
}
...
// SetData gets a reference to the given PlaceLoanResponse and assigns it to the Data field.
