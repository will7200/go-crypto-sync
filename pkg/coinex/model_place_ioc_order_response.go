...
// PlaceIocOrderResponse PlaceIocOrder Response Value
type PlaceIocOrderResponse struct {
	// order count
...
func (o PlaceIocOrderResponse) MarshalJSON() ([]byte, error) {
...
type NullablePlaceIocOrderResponse struct {
	value *PlaceIocOrderResponse
	isSet bool
}

func (v NullablePlaceIocOrderResponse) Get() *PlaceIocOrderResponse {
	return v.value
}

func (v *NullablePlaceIocOrderResponse) Set(val *PlaceIocOrderResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePlaceIocOrderResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePlaceIocOrderResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePlaceIocOrderResponse(val *PlaceIocOrderResponse) *NullablePlaceIocOrderResponse {
	return &NullablePlaceIocOrderResponse{value: val, isSet: true}
}

func (v NullablePlaceIocOrderResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePlaceIocOrderResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
