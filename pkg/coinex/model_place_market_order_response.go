...
// PlaceMarketOrderResponse PlaceMarketOrder Response Value
...
func (o PlaceMarketOrderResponse) MarshalJSON() ([]byte, error) {
...
type NullablePlaceMarketOrderResponse struct {
	value *PlaceMarketOrderResponse
	isSet bool
}

func (v NullablePlaceMarketOrderResponse) Get() *PlaceMarketOrderResponse {
	return v.value
}

func (v *NullablePlaceMarketOrderResponse) Set(val *PlaceMarketOrderResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePlaceMarketOrderResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePlaceMarketOrderResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePlaceMarketOrderResponse(val *PlaceMarketOrderResponse) *NullablePlaceMarketOrderResponse {
	return &NullablePlaceMarketOrderResponse{value: val, isSet: true}
}

func (v NullablePlaceMarketOrderResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePlaceMarketOrderResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true
