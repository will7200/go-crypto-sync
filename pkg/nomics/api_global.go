...
type ApiGetGlobalTickerRequest struct {
...
func (r ApiGetGlobalTickerRequest) Convert(convert string) ApiGetGlobalTickerRequest {
	r.convert = &convert
	return r
}

func (r ApiGetGlobalTickerRequest) Execute() (InlineResponse2003, *_nethttp.Response, error) {
	return r.ApiService.GetGlobalTickerExecute(r)
}

/*
 * GetGlobalTicker Global Ticker
 ...
 * @return ApiGetGlobalTickerRequest
*/
func (a *GlobalApiService) GetGlobalTicker(ctx _context.Context) ApiGetGlobalTickerRequest {
	return ApiGetGlobalTickerRequest{
		ApiService: a,
		ctx:        ctx,
	}
 ...
 */
func (a *GlobalApiService) GetGlobalTickerExecute(r ApiGetGlobalTickerRequest) (InlineResponse2003, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GlobalApiService.GetGlobalTicker")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/global-ticker"
