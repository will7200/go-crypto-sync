...
type ApiGetVolumeHistoryRequest struct {
...
func (r ApiGetVolumeHistoryRequest) Start(start string) ApiGetVolumeHistoryRequest {
	r.start = &start
	return r
}

// end  End time of the interval in RFC3339 (URI escaped). If not provided, the current time is used.
func (r ApiGetVolumeHistoryRequest) End(end string) ApiGetVolumeHistoryRequest {
	r.end = &end
	return r
}

// convert  Currency to quote volume values. May be a Fiat Currency or Cryptocurrency. Default is `USD`.
func (r ApiGetVolumeHistoryRequest) Convert(convert string) ApiGetVolumeHistoryRequest {
	r.convert = &convert
	return r
}

// format  Format of the response. Defaults to JSON when blank.
func (r ApiGetVolumeHistoryRequest) Format(format string) ApiGetVolumeHistoryRequest {
	r.format = &format
	return r
}
...
func (r ApiGetVolumeHistoryRequest) IncludeTransparency(includeTransparency bool) ApiGetVolumeHistoryRequest {
	r.includeTransparency = &includeTransparency
	return r
}

func (r ApiGetVolumeHistoryRequest) Execute() ([]InlineResponse20016, *_nethttp.Response, error) {
	return r.ApiService.GetVolumeHistoryExecute(r)
}

/*
 * GetVolumeHistory Global Volume History
 ...
 * @return ApiGetVolumeHistoryRequest
*/
func (a *VolumeApiService) GetVolumeHistory(ctx _context.Context) ApiGetVolumeHistoryRequest {
	return ApiGetVolumeHistoryRequest{
		ApiService: a,
		ctx:        ctx,
	}
 ...
 */
func (a *VolumeApiService) GetVolumeHistoryExecute(r ApiGetVolumeHistoryRequest) ([]InlineResponse20016, *_nethttp.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "VolumeApiService.GetVolumeHistory")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/volume/history"
