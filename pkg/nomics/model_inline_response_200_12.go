...
type InlineResponse20012 struct {
	...
	// Nomics ID of the base currency
	Base *string `json:"base,omitempty"`
	// Nomics ID of the quote currency
	Quote *string `json:"quote,omitempty"`
	// Price in the quote currency of the most recent trade
	PriceQuote *string `json:"price_quote,omitempty"`
	// RFC3339 Timestamp of the most recent trade
