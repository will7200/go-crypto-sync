...
type InlineResponse20018 struct {
	// RFC3339 timestamp of the order book snapshot
	Timestamp *string `json:"timestamp,omitempty"`
	// Tuples of bids in descending order (first entry is best bid). First entry is price in the quote currency. Second entry is volume of the base currency.
	Bids *[][]float32 `json:"bids,omitempty"`
	// Tuples of asks in ascending order (first entry is best ask). First entry is price in the quote currency. Second entry is volume of the base currency.
