...
type InlineResponse20020 struct {
	...
	// Volume weighted average of first trade prices in quote currency
	Open *string `json:"open,omitempty"`
	// Volume weighted average of last trade prices in quote currency
	...
	// True when the candle is a price outlier.  May be null if outlier detection has not been applied to the candle.
	PriceOutlier *bool `json:"price_outlier,omitempty"`
	// True when the candle is a volume outlier.  May be null if outlier detection has not been applied to the candle.
	VolumeOutlier *bool `json:"volume_outlier,omitempty"`
}
...
// GetPriceOutlier returns the PriceOutlier field value if set, zero value otherwise.
func (o *InlineResponse20020) GetPriceOutlier() bool {
	if o == nil || o.PriceOutlier == nil {
		var ret bool
		return ret
	}
	return *o.PriceOutlier
}

// GetPriceOutlierOk returns a tuple with the PriceOutlier field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InlineResponse20020) GetPriceOutlierOk() (*bool, bool) {
	if o == nil || o.PriceOutlier == nil {
		return nil, false
	}
	return o.PriceOutlier, true
}
...
// SetPriceOutlier gets a reference to the given bool and assigns it to the PriceOutlier field.
func (o *InlineResponse20020) SetPriceOutlier(v bool) {
	o.PriceOutlier = &v
}

// GetVolumeOutlier returns the VolumeOutlier field value if set, zero value otherwise.
func (o *InlineResponse20020) GetVolumeOutlier() bool {
	if o == nil || o.VolumeOutlier == nil {
		var ret bool
		return ret
	}
	return *o.VolumeOutlier
}

// GetVolumeOutlierOk returns a tuple with the VolumeOutlier field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InlineResponse20020) GetVolumeOutlierOk() (*bool, bool) {
	if o == nil || o.VolumeOutlier == nil {
		return nil, false
	}
	return o.VolumeOutlier, true
}
...
// SetVolumeOutlier gets a reference to the given bool and assigns it to the VolumeOutlier field.
...
func (o InlineResponse20020) MarshalJSON() ([]byte, error) {
	...
	if o.PriceOutlier != nil {
		toSerialize["price_outlier"] = o.PriceOutlier
	}
	if o.VolumeOutlier != nil {
		toSerialize["volume_outlier"] = o.VolumeOutlier
	}
