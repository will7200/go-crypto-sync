...
type InlineResponse20022 struct {
	...
	Predictions *[]InlineResponse20022Predictions `json:"predictions,omitempty"`
}
...
func (o *InlineResponse20022) GetPredictions() []InlineResponse20022Predictions {
	if o == nil || o.Predictions == nil {
		var ret []InlineResponse20022Predictions
		return ret
	}
...
// SetPredictions gets a reference to the given []InlineResponse20022Predictions and assigns it to the Predictions field.
