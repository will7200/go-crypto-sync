...
type InlineResponse20026 struct {
	// Market performance over the past 24 hours
	Day *[]MarketCapSparklineRow `json:"day,omitempty"`
	// Market performance over the past 7 days
	Week *[]MarketCapSparklineRow `json:"week,omitempty"`
	// Market performance over the past 30 days
	Month *[]MarketCapSparklineRow `json:"month,omitempty"`
	// Market performance over the past 365 days
	Year *[]MarketCapSparklineRow `json:"year,omitempty"`
}
...
// SetDay gets a reference to the given []MarketCapSparklineRow and assigns it to the Day field.
...
// SetWeek gets a reference to the given []MarketCapSparklineRow and assigns it to the Week field.
...
// SetMonth gets a reference to the given []MarketCapSparklineRow and assigns it to the Month field.
...
// SetYear gets a reference to the given []MarketCapSparklineRow and assigns it to the Year field.
