...
// MarketInterval struct for MarketInterval
...
func (o MarketInterval) MarshalJSON() ([]byte, error) {
...
type NullableMarketInterval struct {
	value *MarketInterval
	isSet bool
}

func (v NullableMarketInterval) Get() *MarketInterval {
	return v.value
}

func (v *NullableMarketInterval) Set(val *MarketInterval) {
	v.value = val
	v.isSet = true
}

func (v NullableMarketInterval) IsSet() bool {
	return v.isSet
}

func (v *NullableMarketInterval) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMarketInterval(val *MarketInterval) *NullableMarketInterval {
	return &NullableMarketInterval{value: val, isSet: true}
}

func (v NullableMarketInterval) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMarketInterval) UnmarshalJSON(src []byte) error {
	v.isSet = true
